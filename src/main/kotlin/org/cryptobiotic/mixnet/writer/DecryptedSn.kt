...
fun DecryptedSn.publishJson() =
    DecryptedSnJson(shuffledRow, encrypted_sn.publishJson(), Ksn.publishJson(),  proof.publishJson(), ballotStyleIdx)
...
fun DecryptedSnJson.import(group: GroupContext, errs: ErrorMessages = ErrorMessages("DecryptedSnsJson.import")): DecryptedSn? {
    ...
    return if (errs.hasErrors()) null else DecryptedSn(this.shuffled_row, encryptedSn!!, Ksn!!, proof!!, ballotStyleIdx)
}
