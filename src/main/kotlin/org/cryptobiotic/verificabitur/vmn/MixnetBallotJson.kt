...
fun MixnetBallotJson.import(group: GroupContext) : List<VectorCiphertext> {
    val mxBallots =
        wtf.map { padAndData ->
            ...
            VectorCiphertext(group, ciphers)
        }
    return mxBallots
}

fun readMixnetJsonBallots(group: GroupContext, filename: String): List<VectorCiphertext> {
